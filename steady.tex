...
\begin{figure*}
    ...
    \small The Greenwald Density Limit is a robust metric of what densities an H-Mode plasma can attain. Although empirical in nature, \replaced{it accurately predicts when a tokamak will undergo degraded plasma transport.\cite{greenwald,iterdb}}{it is an indicator for good transport regimes.}
    \label{fig:greenwald}
\end{figure*}
